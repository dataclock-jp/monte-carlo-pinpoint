...
\begin{figure}[t]
  \centering
  \resizebox{\columnwidth}{!}{\input{figures/algorithm_overview}}
...
\begin{figure}[t]
  \centering
  \input{figures/accuracy_comparison}
...
%% ================================================================
\input{sections/hallucination_taxonomy}
...
\url{https://github.com/dataclock-jp/monte-carlo-pinpoint}.  The
state reported in this paper is fixed by the annotated tag
\texttt{v1.0-arxiv-v1}.\par}
